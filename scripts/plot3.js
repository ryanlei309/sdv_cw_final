...
const { select, csv, scaleLinear, max, scaleBand, axisLeft, axisBottom, format, scaleOrdinal, interpolateSpectral, schemeSpectral, schemeAccentm, color} = d3
...
const render = data => {
    ...
    const colorScale = scaleOrdinal(schemeAccentm);
    ...
    colorScale.domain(schemeAccentm.map(d => d.clade));
