...
const { select, csv, scaleLinear, max, scaleBand, axisLeft, axisBottom, format, scaleOrdinal, interpolateHcl, color} = d3
...
const render = data => {
    ...
    const colorScale = scaleOrdinal(interpolateHcl);
    ...
    colorScale.domain(interpolateHcl.map(d => d.clade));
