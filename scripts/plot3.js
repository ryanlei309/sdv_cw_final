...
const { select, csv, scaleLinear, max, scaleBand, axisLeft, axisBottom, format, scaleOrdinal, interpolateSpectral, schemeSpectral, schemeAccentm, schemeCategory20, color} = d3
...
const render = data => {
    ...
    colorScale.domain(schemeCategory20.map(d => d.clade));
