...
const { select, csv, scaleLinear, max, scaleBand, axisLeft, axisBottom, format, scaleOrdinal, schemeSpectral, color} = d3
...
const render = data => {
    ...
    const colorScale = scaleOrdinal(schemeSpectral[21]);
